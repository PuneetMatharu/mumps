...
option(
  find_static
  "Find static libraries for Lapack and Scalapack (default shared then static search)"
)
...
if(CMAKE_PREFIX_PATH)
  set(EXPANDED_CMAKE_PREFIX_PATHS)
  foreach(OLD_PATH IN LISTS CMAKE_PREFIX_PATH)
    get_filename_component(OLD_PATH ${OLD_PATH} ABSOLUTE)
    list(APPEND EXPANDED_CMAKE_PREFIX_PATHS ${OLD_PATH})
  endforeach()
  set(CMAKE_PREFIX_PATH "${EXPANDED_CMAKE_PREFIX_PATHS}")
endif()
